...
if uploaded_files:
    ...
    with tab2:
        ...
        sns.barplot(y=runs_difference.index, x=runs_difference["Runs_Scored"], palette = "mako")
        ...
        plt.figure(dpi=120)
        sns.barplot(x=bowling_diff["Wickets_Taken"], y=bowling_diff.index, palette = "mako")
        ...
        plt.pie(
            runs_contribution_by_role,
            labels=runs_contribution_by_role.index,
            autopct="%1.1f%%",
            startangle=90
        )
        ...
        plt.pie(
            wickets_contribution_by_role,
            labels=wickets_contribution_by_role.index,
            autopct="%1.1f%%",
            startangle=90
        )
